...
function clearSession() {
  sessionStorage.removeItem("hmsUser");
}
...
function isPageAllowed(user, page) {
  ...
  return (allowedPages[user.role] || []).includes(page);
}
...
function initSidebar(activeId) {
  ...
  if (user) {
    ...
    if (user.role === "PATIENT") {
      document
        .querySelectorAll(
          '[data-page="doctors"], [data-page="patients"], [data-page="users"], [data-page="billing"], [data-role="ADMIN"], a[href="doctors.html"], a[href="patients.html"], a[href="users.html"], a[href="billing.html"], .admin-only, .doctor-only',
        )
        .forEach((el) => {
      ...
      document
        .querySelectorAll(
          '[data-page="doctors"], [data-page="patients"], [data-page="users"], [data-page="billing"], [data-role="ADMIN"], a[href="doctors.html"], a[href="patients.html"], a[href="users.html"], a[href="billing.html"], .admin-only, .patient-only',
        )
        .forEach((el) => {
          if (el) el.style.display = "none";
        });
      ...
      document
        .querySelectorAll('[data-role="ADMIN"], .admin-only')
        .forEach((el) => {
          if (el) el.style.display = "none";
        });
    }
